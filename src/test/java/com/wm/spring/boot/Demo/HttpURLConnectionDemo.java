 ...
 */
public class HttpURLConnectionDemo implements Runnable{
    public String doPost(String URL) {
        ...
        try {
            ...
            String jsonStr = "{\"quantity\":1,\"productId\":1,\"userId\":1}";
            out.write(jsonStr);
            out.flush();
            out.close();
            //取得输入流，并使用Reader读取
...
//        System.out.println("\nTesting 2 - Do Http POST request");
        http.doPost("http://localhost:8080/buy");
    ...
    public void run() {
        HttpURLConnectionDemo http = new HttpURLConnectionDemo();
        JSONObject jsonObject = new JSONObject(new HashMap<>());
        http.doPost("http://localhost:8081/buy");
    }
}